...
export function ProductRecommendations({ userEmail, className = "" }: ProductRecommendationsProps) {
  const { recommendations, isLoading, error, getRecommendations, refreshRecommendations } =
    useRecommendations(userEmail)
  const [selectedCategory, setSelectedCategory] = useState<string>("digital")
  const [favorites, setFavorites] = useState<Set<string>>(new Set())

  const categories = [
    { id: "digital", name: "Digital", icon: ShoppingBag, color: "text-blue-600", bgColor: "bg-blue-50" },
    { id: "clothes", name: "Fashion", icon: Shirt, color: "text-purple-600", bgColor: "bg-purple-50" },
    { id: "food", name: "Food", icon: Coffee, color: "text-orange-600", bgColor: "bg-orange-50" },
    { id: "orders", name: "Services", icon: Package, color: "text-green-600", bgColor: "bg-green-50" },
  ]
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-1">
            ...
            >
              ...
              {product.productUrl ? "Mua ngay" : "Add to Cart"}
            </Button>
            <Button
              variant="outline"
              size="sm"
          ...
          {categories.map((category) => {
            ...
            return (
              <Button
                ...
                className={`h-10 ${
                  isSelected ? "bg-blue-600 hover:bg-blue-700 text-white" : "border-gray-200 hover:bg-gray-50"
          ...
          <div className="flex items-center justify-center h-32">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-gray-600">
                {isLoading ? "Loading recommendations..." : "Select a category to see recommendations"}
              </p>
            </div>
          </div>
        )}
