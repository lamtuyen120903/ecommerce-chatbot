...
export function EnvSetup() {
  ...
  const categoryEndpoints = [
    ...
    },
    {
      ...
      url: workingWebhookUrl,
      description: "Xử lý món ăn, nguyên liệu, tùy chọn ăn kiêng và giao hàng",
    ...
    },
    {
      ...
      url: workingWebhookUrl,
      description:
        "Xử lý theo dõi đơn hàng, trả hàng, đổi hàng và trạng thái giao hàng",
    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="flex items-center space-x-2">
          ...
          <span>Cấu hình Chatbot N8N</span>
        </CardTitle>
        <CardDescription>
          Thiết lập hiện tại sử dụng một webhook hoạt động với ngữ cảnh theo
          danh mục để có phản hồi chuyên biệt
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            <strong>Thiết lập hiện tại:</strong> Tất cả danh mục sử dụng cùng
            một URL webhook hoạt động với các tham số ngữ cảnh khác nhau. Điều
            này cho phép phản hồi chuyên biệt trong khi sử dụng một quy trình
            n8n duy nhất. Bạn có thể tạo các quy trình riêng biệt sau này để có
            hành vi chuyên biệt hơn.
          </AlertDescription>
        </Alert>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
            ...
            <ul className="text-xs text-yellow-700 space-y-1">
              <li>• Tạo các quy trình n8n riêng biệt cho từng danh mục</li>
              <li>
                • Sử dụng các URL webhook khác nhau để có phản hồi chuyên biệt
                hơn
              </li>
              <li>• Huấn luyện từng quy trình với kiến thức theo danh mục</li>
            </ul>
          </div>
        </div>
      </CardContent>
