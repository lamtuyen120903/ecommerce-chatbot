...
export default function MyOrdersPage() {
  ...
  const getStageIcon = (
    stage: string,
    stageData: { completed: boolean; active: boolean }
  ) => {
                  ...
                  <div className="flex items-center justify-between relative">
                    ...
                    <div className="flex items-center justify-between w-full relative z-10">
                      <div className="flex flex-col items-center">
                        <div
                          className={`w-12 h-12 rounded-full flex items-center justify-center ${getStageStyle(
                            order.stages.orderPlaced
                          )}`}
                        >
                          {getStageIcon(
                            "orderPlaced",
